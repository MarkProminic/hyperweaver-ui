    ...
    <div className="card">
      <div className="card-body">
        <h4 className="fs-6 fw-bold mb-3">
          ...
          <span>{t('hostCharts.helpSection.sectionTitle')}</span>
        </h4>
        ...
        <div className="small">
          <div className="row g-3">
            <div className="col">
              <p>
                <strong>{t('hostCharts.helpSection.applyMethodsTitle')}:</strong>
              </p>
              <ul>
                <li>
            ...
            <div className="col">
              <p>
                <strong>{t('hostCharts.helpSection.bestPracticesTitle')}:</strong>
              </p>
              <ul>
