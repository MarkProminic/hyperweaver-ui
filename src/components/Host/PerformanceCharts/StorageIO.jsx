        ...
        <header className="card-header bg-dark d-flex justify-content-between align-items-center">
          <p className="text-white fw-bold mb-0">
            <span className="d-inline-flex align-items-center gap-1">
              ...
              <span>{t('hostCharts.storageIOChart.title')}</span>
            </span>
          </p>
          <div>
            <div className="d-flex gap-2">
              <div>
                <button
                  ...
                  title={t('hostCharts.storageIOChart.toggleReadTitle')}
                >
                  <span className="me-1">
                    <i
                  ...
                  <span>{t('hostCharts.storageIOChart.readLabel')}</span>
                </button>
              </div>
              <div>
                <button
                  ...
                  title={t('hostCharts.storageIOChart.toggleWriteTitle')}
                >
                  <span className="me-1">
                    <i
                  ...
                  <span>{t('hostCharts.storageIOChart.writeLabel')}</span>
                </button>
              </div>
              <div>
                <button
                  ...
                  title={t('hostCharts.storageIOChart.toggleTotalTitle')}
                >
                  <span className="me-1">
                    <i
                  ...
                  <span>{t('hostCharts.storageIOChart.totalLabel')}</span>
                </button>
              </div>
              <div>
                <button
                  ...
                  title={t('hostCharts.storageIOChart.expandButtonTitle')}
                >
                  <span className="d-inline-flex align-items-center">
        ...
        <div className="card-body p-2">
          {chartData && Object.keys(chartData).length > 0 ? (
            <div>
              <Chart
                options={{
                  ...
                  title: {
                    text: t('hostCharts.storageIOChart.chartTitle'),
                    style: {
                      fontSize: '12px',
                      fontWeight: 'bold',
                      color: '#ffffff',
                  ...
                  yAxis: {
                    title: {
                      text: t('hostCharts.storageIOChart.mbsAxisLabel'),
                      style: {
                        fontSize: '10px',
                        color: '#b0bec5',
                      },
            ...
            <div className="text-center p-4">
              <p className="text-muted">{t('hostCharts.storageIOChart.noDataMessage')}</p>
            </div>
          )}
        </div>
      </div>
