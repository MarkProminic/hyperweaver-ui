    ...
    <tr>
      <td>
        <div className="form-check">
          ...
          >
            {t('artifacts.artifactRow.selectLabel', { filename: artifact.filename })}
          </label>
        </div>
      </td>
      <td>
          ...
          <div>
            ...
            {artifact.source_url && (
              <div className="small text-muted">
                ...
                {t('artifacts.artifactRow.downloadedFromUrl')}
              </div>
            )}
          </div>
        </div>
              ...
              <li>
                <button type="button" className="dropdown-item" onClick={() => onMove(artifact)}>
                  <span className="d-inline-flex align-items-center">
                    ...
                    <span>{t('artifacts.artifactRow.moveOption')}</span>
                  </span>
                </button>
              </li>
              <li>
                <button type="button" className="dropdown-item" onClick={() => onCopy(artifact)}>
                  <span className="d-inline-flex align-items-center">
                    ...
                    <span>{t('artifacts.artifactRow.copyOption')}</span>
                  </span>
                </button>
              </li>
            </ul>
