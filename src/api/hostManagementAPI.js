...
export const restartHost = async (hostname, port, protocol, options = {}) =>
  await makeAgentRequest(hostname, port, protocol, 'system/host/restart', 'POST', {
...
export const rebootHost = async (hostname, port, protocol, options = {}) =>
  await makeAgentRequest(hostname, port, protocol, 'system/host/reboot', 'POST', {
    confirm: true,
...
export const shutdownHost = async (hostname, port, protocol, options = {}) =>
  await makeAgentRequest(hostname, port, protocol, 'system/host/shutdown', 'POST', {
    grace_period: options.gracePeriod || 60,
